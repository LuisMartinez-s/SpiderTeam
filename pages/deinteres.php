...
<h1 class="titulos" id="titulos">Becas</h1>
    <!-- Div para el contenedor de las tarjetas BECAS.-->
    ...
    <h1 class="titulos" id="titulos">Certificaciones</h1>
    <!-- DIV PARA CERTIFICACIONES -->
    <div class="contenedor-tarjetas-interes">
