...
<div class="container">
    ...
    <div class="" id="accordion">
        <div class="faqHeader">Preuntas Generales</div>
        <div class="card ">
            <div class="card-header">
                <h4 class="card-header">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" >Como programo una visita?</a>
                </h4>
            </div>
